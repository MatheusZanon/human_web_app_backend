# Generated by Django 5.0.3 on 2024-06-12 17:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('TEXT', 'TEXT'), ('DATE', 'DATE'), ('BOOLEAN', 'BOOLEAN'), ('FLOAT', 'FLOAT'), ('INTEGER', 'INTEGER')], default='TEXT', max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reembolsos', to='human_app.clientesfinanceiro')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='valores', to='human_app.clientesfinanceiro')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefone_celular', models.CharField(blank=True, max_length=25, null=True)),
                ('situacao', models.CharField(default='INATIVO', max_length=100)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='funcionarios', to=settings.AUTH_USER_MODEL)),
            ],
            options={
