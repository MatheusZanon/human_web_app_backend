...
class XMLHelper:
    ...
    def __get_namespace_from_xsd(self, eventType: ESocialTipoEvento) -> str:
        """
        ...
        """
        xsd_path = os.path.join(INTEGRATION_ROOT_PATH, 'xsd', f'{eventType.value[0]}.xsd')
    ...
    def create_root_element(self, root_tag: str, ns: Optional[Dict[Optional[str], str]] = None, **kwargs: Any) -> etree._Element:
        ...
        return etree.Element(root_tag, nsmap=ns, **kwargs)
