# Generated by Django 5.0.3 on 2024-06-24 15:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='tipo',
            field=models.CharField(choices=[('BOOLEAN', 'BOOLEAN'), ('INTEGER', 'INTEGER'), ('DATE', 'DATE'), ('FLOAT', 'FLOAT'), ('TEXT', 'TEXT')], default='TEXT', max_length=255),
        ),
